...
- **配布用 ZIP（いまの版）:** [ai-usage-monitor-v0.2.1.zip をダウンロード](https://github.com/sinoda1114/AI-Usage-Monitor/raw/main/releases/ai-usage-monitor-v0.2.1.zip)（`main` の `releases` への直リンクです）
