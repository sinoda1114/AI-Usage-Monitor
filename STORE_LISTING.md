...
**リポジトリの `releases/ai-usage-monitor-store-v0.2.5.zip` も同じ中身です。** そのままダウンロードして使う場合:  
`https://github.com/sinoda1114/AI-Usage-Monitor/raw/main/releases/ai-usage-monitor-store-v0.2.5.zip`  
